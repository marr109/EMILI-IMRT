...
# Uso: scripts/run_ils_batch.sh <step> <first|best> <restricted|unrestricted>
# Corre 15 semillas de ILS (AngleShiftMultiPerturbation, 3 pasos, tmaxiter 10,
# rejectrepeated) sobre CERR_Prostate, catálogo indicado. Salida en:
#   experiments/ils/nangshift<step>/<catalog>/data/<strategy>/seedNN/
#
# El catálogo "restricted" ya existe bajo el nombre histórico "grid5"
# (experiments/ils/nangshift<step>/grid5/) y NO se toca ni se recrea acá --
# este script solo escribe bajo "restricted"/"unrestricted", así que
# invocarlo con "restricted" genera una carpeta nueva en paralelo a grid5,
# no la sobreescribe.
...
OUTBASE="experiments/ils/nangshift${STEP}/${CATALOG}/data/${STRATEGY}"
LOG="experiments/ils/nangshift${STEP}/${CATALOG}/${STRATEGY}_batch.log"
