...
#define COMPONENT_REMOVAL                       0xB5
#define COMPONENT_INSERTION                     0xB6
...
public:
    ...
    virtual emili::Removal* buildRemoval(){return nullptr;}
    /**
     * @brief buildProblem
     *          This method is called by buildComponent(type) if type is COMPONENT_PROBLEM.
     * @return
     *       a pointer to an object of type COMPONENT_PROBLEM or, if nothing found, nullptr.
     */
    virtual emili::Insertion* buildInsertion(){return nullptr;}
    /**
     * @brief buildProblem
     *          This method is called by buildComponent(type) if type is COMPONENT_PROBLEM.
     * @return
